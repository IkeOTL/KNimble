 ...
 * @author IkeOTL
 */
public class DemoRodContraint0 extends RenderLoop {

    public DemoRodContraint0(String title, PhysicsSpace physicsSpace) {
        super(title, physicsSpace);
    }

    public static void main(String[] args) throws Exception {
        new DemoRodContraint0("Display Test", new PhysicsSpace()).start();
    }
...
//        shapes.add(new Shape(cube, i0));
        ...
        Constraint con0 = new RodConstraint(r0, r1);
