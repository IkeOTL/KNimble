 ...
 * @author IkeOTL
 */
public class DemoSpheresCubes2 extends RenderLoop {

    public DemoSpheresCubes2(String title, PhysicsSpace physicsSpace) {
        super(title, physicsSpace);
    }

    public static void main(String[] args) throws Exception {
        new DemoSpheresCubes2("Demo: Sphere/Cube Collision", new PhysicsSpace()).start();
    }
