 ...
 * @author IkeOTL
 */
public class DemoSpheresCubes1 extends RenderLoop {

    public DemoSpheresCubes1(String title, PhysicsSpace physicsSpace) {
        super(title, physicsSpace);
    }

    public static void main(String[] args) throws Exception {
        new DemoSpheresCubes1("Demo: Sphere/Cube Collision", new PhysicsSpace()).start();
    }
    ...
    protected List<Shape> init(PhysicsSpace physicsSpace) {
        ...
        shapes.add(s2);
        s2.getColor().set(1, 0, 0, 1);
        r2.getTransform().setPosition(2f, 5, -15f);
